...
public class RobotContainer {
  ...
  private boolean anyBumper() {
    return m_copilotController.L2().getAsBoolean() || m_copilotController.R2().getAsBoolean();
  }
